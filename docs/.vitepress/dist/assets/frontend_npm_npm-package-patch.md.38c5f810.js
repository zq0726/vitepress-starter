import{_ as s,o as a,c as n,O as e}from"./chunks/framework.1fb06b91.js";const C=JSON.parse('{"title":"依赖包重新打包","description":"","frontmatter":{},"headers":[],"relativePath":"frontend/npm/npm-package-patch.md","lastUpdated":1682580196000}'),l={name:"frontend/npm/npm-package-patch.md"},p=e(`<h1 id="依赖包重新打包" tabindex="-1">依赖包重新打包 <a class="header-anchor" href="#依赖包重新打包" aria-label="Permalink to &quot;依赖包重新打包&quot;">​</a></h1><h2 id="设置package-json" tabindex="-1">设置package.json <a class="header-anchor" href="#设置package-json" aria-label="Permalink to &quot;设置package.json&quot;">​</a></h2><div class="language-json line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang">json</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">{</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#A6ACCD;">package-name+0.44.0.dev.patch</span></span></code></pre><div class="line-numbers-wrapper" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br></div></div>`,14),r=[p];function c(o,i,t,b,u,m){return a(),n("div",null,r)}const y=s(l,[["render",c]]);export{C as __pageData,y as default};
